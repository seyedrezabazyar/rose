<!DOCTYPE html>
<html lang="{{config('app.locale')}}" class="light-style customizer-hide" dir="{{config('app.direction')}}" data-theme="theme-default" data-assets-path="../../auth-assets/" data-template="vertical-menu-template">
<head>
    ...
    <link rel="stylesheet" href="{{asset('auth-assets/vendor/fonts/flag-icons.css')}}">
    <!-- Core CSS -->
    <link rel="stylesheet" href="{{asset('auth-assets/vendor/css/rtl/core.css')}}" class="template-customizer-core-css">
    <link rel="stylesheet" href="{{asset('auth-assets/vendor/css/rtl/theme-default.css')}}" class="template-customizer-theme-css">
    <link rel="stylesheet" href="{{asset('auth-assets/css/demo.css')}}">
    <link rel="stylesheet" href="{{asset('auth-assets/vendor/css/rtl/rtl.css')}}">
    <!-- Vendors CSS -->
    <link rel="stylesheet" href="{{asset('auth-assets/vendor/libs/perfect-scrollbar/perfect-scrollbar.css')}}">
    <link rel="stylesheet" href="{{asset('auth-assets/vendor/libs/typeahead-js/typeahead.css')}}">
    <!-- Vendor -->
    <link rel="stylesheet" href="{{asset('auth-assets/vendor/libs/formvalidation/dist/css/formValidation.min.css')}}">
    <!-- Page CSS -->
    <!-- Page -->
    ...
    <script src="{{asset('auth-assets/vendor/js/template-customizer.js')}}"></script>
...
<script src="{{asset('auth-assets/vendor/libs/hammer/hammer.js')}}"></script>
<script src="{{asset('auth-assets/vendor/libs/i18n/i18n.js')}}"></script>
<script src="{{asset('auth-assets/vendor/libs/typeahead-js/typeahead.js')}}"></script>
<script src="{{asset('auth-assets/vendor/js/menu.js')}}"></script>
<!-- endbuild -->
<!-- Vendors JS -->
<script src="{{asset('auth-assets/vendor/libs/formvalidation/dist/js/FormValidation.min.js')}}"></script>
<script src="{{asset('auth-assets/vendor/libs/formvalidation/dist/js/plugins/Bootstrap5.min.js')}}"></script>
<script src="{{asset('auth-assets/vendor/libs/formvalidation/dist/js/plugins/AutoFocus.min.js')}}"></script>
<!-- Main JS -->
